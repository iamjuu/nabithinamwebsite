...
const latestPosts = [
  ...
  {
    id: 4,
    title: "Abu Bakr (RA) - The First Caliph and Closest Companion",
    excerpt: "Learn about Abu Bakr's unwavering faith, his close relationship with the Prophet, and his leadership.",
